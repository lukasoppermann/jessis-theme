			...
			<div class="posts">
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="post-meta-bottom">
						...
						<p class="post-categories">Kategorie: <?php the_category(', '); ?></p>
						...
						<div class="post-nav">
							...
							if (!empty( $prev_post )): ?>
								...
								<a class="post-nav-older" title="<?php _e('Previous post:', 'jessica'); echo ' ' . get_the_title($prev_post); ?>" href="<?php echo get_permalink( $prev_post->ID ); ?>">

								<h5><?php _e('Previous post', 'jessica'); ?></h5>
							...
							if (!empty( $next_post )): ?>
								...
								<a class="post-nav-newer" title="<?php _e('Next post:', 'jessica'); echo ' ' . get_the_title($next_post); ?>" href="<?php echo get_permalink( $next_post->ID ); ?>">

								<h5><?php _e('Next post', 'jessica'); ?></h5>
